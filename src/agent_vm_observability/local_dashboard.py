...
def run_dashboard(memory_db: Path, host: str, port: int) -> None:
    ...
    print(f"coding-agent-sentry-observability dashboard: http://{host}:{port}", flush=True)
...
<head>
  <meta charset="utf-8" />
  <title>coding-agent-sentry-observability</title>
  <style>
    :root {{
      color-scheme: dark;
      --bg: #08111a;
...
<body>
  <header>
    <h1>coding-agent-sentry-observability</h1>
